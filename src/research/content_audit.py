...
"""
        for reuse_opp in analysis.repurpose_opportunities:
            md += f"""
### {reuse_opp.source_content}
→ **{reuse_opp.repurpose_into}** on {reuse_opp.target_platform}
- **Why:** {reuse_opp.why_repurpose}
- **Estimated Reach:** {reuse_opp.estimated_reach}
"""
